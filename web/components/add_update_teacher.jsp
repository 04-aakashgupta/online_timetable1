...
<% String error_and_msg_teacher_add_update = "";
    ...
    if (session.getAttribute("error_and_msg_teacher_add_update") != null) {
        error_and_msg_teacher_add_update = session.getAttribute("error_and_msg_teacher_add_update").toString();
    }

    session.setAttribute("error_and_msg_teacher_add_update", null);
...
<div class="add_update_teacher ">



    <div class=" col-xl-5 col-lg-5 col-md-10 col-sm-12  col-12  text-center mx-auto mt-2  mb-5  ">
        <h1 class="h1 text-center  text-dark">Add Update Teacher</h1>
        <h3 ><%= error_and_msg_teacher_add_update %></h3>
        <form action="add_update_teacher_server.jsp" method="post">
